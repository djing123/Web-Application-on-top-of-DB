		...
		<tr>
			...
			<%
                    ...
                    if (action != null && action.equals("search")) {
                        ...
                        String s_quarter = token[2];
                        String s_year = token[3];
                        ...
                        "AND c.course_number = ? AND s.faculty = ? AND c.quarter = ? AND c.year = ? " +
                        "AND p.grade IN ('A+', 'A', 'A-')) AS A1"); 

                        pstmt.setString(1, s_course);
                        pstmt.setString(2, s_professor);
                        pstmt.setString(3, s_quarter);
                        pstmt.setInt(4, Integer.parseInt(s_year));
                        ...
                        pstmt2.setString(3, s_quarter);
                        pstmt2.setInt(4, Integer.parseInt(s_year));
                        ...
                        pstmt3.setString(3, s_quarter);
                        pstmt3.setInt(4, Integer.parseInt(s_year));
                        ...
                        pstmt4.setString(3, s_quarter);
                        pstmt4.setInt(4, Integer.parseInt(s_year));
                        ...
                        pstmt5.setString(3, s_quarter);
                        pstmt5.setInt(4, Integer.parseInt(s_year));
            ...
            <%
                ...
                info = s1.executeQuery("SELECT DISTINCT c.course_number AS COURSE, s.faculty AS Professor, c.quarter AS QUARTER, c.year AS YEAR " +
                        ...
                        <form action="3.jsp" method="get">
                            ...
                            <select name = "everything">
                                <% 
                                    while ( info.next() ){
                                %>
                                     <option value="<%= info.getString("COURSE") %>,<%= info.getString("Professor") %>,<%= info.getString("QUARTER") %>,<%= info.getString("YEAR") %>"><%= info.getString("COURSE") %>,<%= info.getString("Professor") %>,<%= info.getString("QUARTER") %>,<%= info.getString("YEAR") %></option>
                                <%
                                    }
                                %>
