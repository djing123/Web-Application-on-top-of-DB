		...
		<tr>
			...
			<%
                    ...
                    if (action != null && action.equals("search")) {
                        ...
                        String s_course = request.getParameter("everything");
                        ...
                        "WHERE p.course = c.course_number " + 
                        "AND c.course_number = ? " +
            ...
            <%
                ...
                info = s1.executeQuery("SELECT DISTINCT c.course_number AS COURSE " +
                    "FROM classes c");
            ...
            <table border="0"><th><font face = "Arial Black" size = "4">COURSE INFO</font></th></table>
                <table border="1">
                    ...
                    <tr>
                        <form action="3_4.jsp" method="get">
                            ...
                            <select name = "everything">
                                <% 
                                    while ( info.next() ){
                                %>
                                     <option value="<%= info.getString("COURSE") %>"><%= info.getString("COURSE") %></option>
                                <%
                                    }
                                %>
